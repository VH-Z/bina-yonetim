...
<div class="card">
  ...
  {icerik}
    ...
    def _uyari_pdf_olustur(self, daire_no, ana_para_str):
        ...
        tarih_s  = ParagraphStyle("tarih",  fontSize=10, fontName=font_normal,
            alignment=TA_RIGHT, spaceAfter=0)

        bugun_tarih = datetime.date.today().strftime("%d.%m.%Y")
        tarih_tablosu = Table(
            [[Paragraph("", tarih_s), Paragraph(bugun_tarih, tarih_s)]],
            colWidths=["75%", "25%"],
